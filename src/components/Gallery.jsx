...
export function Gallery() {
  ...
  const validImages = useMemo(
    () => galleryImages.filter((img) => img && typeof img.src === 'string' && img.src.trim() !== ''),
    [],
  )
      ...
      <div className="mx-auto max-w-6xl">
        ...
        {hasPhotos ? (
          ...
          <div
            className="mt-10 columns-1 gap-4 sm:columns-2 lg:columns-3"
            role="list"
            aria-label="Placeholder gallery tiles — add photos in galleryImages.js"
          >
